package com.powersi.midd.dataStructrue;
...
public class SearchBinaryTree<E> {
    ...
    public SearchBinaryTree(List<E> elements) {
        for (E e : elements) {
            add(e);
        }
    }

    public SearchBinaryTree(E[] elements) {
        for (E e : elements) {
            add(e);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SearchBinaryTree<Integer> tree = new SearchBinaryTree<Integer>(elements);
